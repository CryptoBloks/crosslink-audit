...
// Function to fetch all Libre account data from the CBTC bridge contract
...
async function processAddresses() {
    ...
    if (specificWalletAddress) {
        ...
        console.log(`Found ${allLibreAccounts.length} CBTC bridge wallet addresses to analyze...\n`);
...
// Start the process
console.log(`Starting CBTC transaction analysis in ${isTestMode ? `TEST mode (${testQty} addresses)` : 'FULL mode'} on ${isTestnet ? 'TESTNET' : 'MAINNET'}...`);
